    ...
    <>
      ...
      <SeccionConImg
        ...
        text={[
          ...
          "Incluye la administración de estacionamientos con asignación dinámica y control de ocupación por condominio.",
      ...
      <SeccionConImg
        title="Evolución hacia una gestión urbana inteligente"
        text={[
