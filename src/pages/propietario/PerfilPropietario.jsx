...
import { User, Mail, Home, Save, X, MapPin, Building, ShieldCheck, Edit3, Lock } from "lucide-react";
  ...
  return (
    <div style={{ fontFamily: 'system-ui, sans-serif', padding: '1.5rem', maxWidth: "600px", margin: "0 auto" }}>
      ...
      <div style={{
        ...
        borderRadius: "28px", padding: "2rem", color: "white", boxShadow: "0 10px 25px rgba(234,88,12,0.2)", marginBottom: "1.5rem"
      }}>
      ...
      <div style={{ background: "white", borderRadius: "24px", padding: "1.5rem", border: "1px solid #f1f5f9", boxShadow: "0 4px 15px rgba(0,0,0,0.05)" }}>
        ...
        <button
          ...
          style={{ marginTop: "1.5rem", width: "100%", background: colores.naranjaPrincipal, color: "white", padding: "0.9rem", borderRadius: "14px", border: "none", cursor: "pointer", fontWeight: "700", transition: "all 0.2s ease", display: "flex", alignItems: "center", justifyContent: "center", gap: "8px" }}
        >
      ...
      {modal && (
        <div style={{ position: "fixed", inset: 0, background: "rgba(15, 23, 42, 0.4)", backdropFilter: "blur(8px)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 1000, opacity: animarModal ? 1 : 0, transition: "opacity 0.3s ease" }}>
          <div style={{ 
            ...
            opacity: animarModal ? 1 : 0, transform: animarModal ? "scale(1) translateY(0)" : "scale(0.9) translateY(-20px)", transition: "all 0.3s cubic-bezier(0.34, 1.56, 0.64, 1)"
          }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "1.8rem" }}>
              ...
              <button onClick={cerrarModal} style={{ background: "#f1f5f9", border: "none", borderRadius: "10px", padding: "6px", cursor: "pointer", color: colores.lightSlate }}>
                <X size={20}/>
              </button>
            </div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "1.2rem" }}>
              ...
              <div style={{ marginTop: "10px", padding: "15px", background: "#f8fafc", borderRadius: "16px", border: "1px dashed #e2e8f0" }}>
                <div style={{ display: "flex", alignItems: "center", gap: "5px", marginBottom: "10px", color: colores.indigoPalido }}>
                  <Lock size={12} /> <span style={{ fontSize: "0.7rem", fontWeight: 700, textTransform: "uppercase" }}>Información de Vivienda</span>
                </div>
                {["condominio", "torre", "piso", "departamento"].map(f => (
                  <div key={f} style={{ marginBottom: "8px" }}>
                    ...
                    <input value={form[f]} readOnly style={inputDisabledStyle} />
                  </div>
                ))}
              </div>
            </div>
            ...
            <button 
              ...
              style={{ marginTop: "2rem", width: "100%", background: colores.naranjaPrincipal, color: "white", border: "none", padding: "0.9rem", borderRadius: "14px", fontWeight: "600", cursor: "pointer", transition: "all 0.2s ease", display: "flex", alignItems: "center", justifyContent: "center", gap: "8px" }}
            >
