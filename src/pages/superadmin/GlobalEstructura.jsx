...
import { FiFolder, FiGrid, FiAlertCircle, FiHome, FiMapPin, FiChevronDown } from "react-icons/fi"
          ...
          <div style={{ backgroundColor: "#fefce8", border: "1px solid #fde047", borderRadius: "0.75rem", padding: "1.25rem 1.5rem", display: "flex", gap: "0.75rem", alignItems: "flex-start" }}>
            ...
            <div>
              ...
              <p style={{ margin: 0, fontSize: "0.85rem", color: "#713f12", lineHeight: "1.5" }}>
                La gesti&oacute;n de torres y pisos desde superadmin requiere el endpoint <code style={{ backgroundColor: "rgba(0,0,0,0.05)", padding: "0.1rem 0.35rem", borderRadius: "0.25rem", fontSize: "0.8rem" }}>GET /api/super-admin/structure</code> en el backend (actualmente devuelve 500).
                Una vez corregido, esta p&aacute;gina mostrar&aacute; y permitir&aacute; editar la estructura completa de cada condominio.
              </p>
            </div>
          </div>
        </>
