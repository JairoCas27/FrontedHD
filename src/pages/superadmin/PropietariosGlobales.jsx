  ...
  return (
    <div style={{ padding: '1.5rem' }}>
      <div className="d-flex justify-content-between align-items-center mb-4">
        <h1 style={{ fontWeight: 700, color: '#1e293b' }}>Propietarios</h1>
        <Button variant="primary" onClick={() => {
          setForm({ nombres: '', apellidos: '', correo: '', telefono: '', contrasena: '', idCondominio: '' });
          setShowModal(true);
        }}>
          <FiPlus className="me-2" /> Nuevo Propietario
        </Button>
      </div>
      ...
      <Modal show={showDetail} onHide={() => setShowDetail(false)} centered>
        <Modal.Header closeButton className="bg-light">
          <Modal.Title>Detalle del Propietario</Modal.Title>
        </Modal.Header>
        <Modal.Body>
          {detailItem && (
            <div>
      ...
      <Modal show={showModal} onHide={() => setShowModal(false)} centered>
        <Modal.Header closeButton className="bg-light">
          <Modal.Title>Nuevo Propietario</Modal.Title>
        </Modal.Header>
        <Form onSubmit={handleSubmit}>
          ...
          <Modal.Footer>
            ...
            <Button type="submit" disabled={submitting}>
              {submitting ? 'Creando...' : 'Crear Propietario'}
            </Button>
          </Modal.Footer>
        </Form>
      </Modal>
