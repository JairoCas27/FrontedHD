...
import { FiPackage, FiGrid, FiAlertCircle, FiHome } from "react-icons/fi"
          ...
          <div style={{ backgroundColor: "#fefce8", border: "1px solid #fde047", borderRadius: "0.75rem", padding: "1.5rem", display: "flex", gap: "0.75rem", alignItems: "flex-start" }}>
            ...
            <div>
              ...
              <p style={{ margin: 0, fontSize: "0.85rem", color: "#713f12", lineHeight: "1.5" }}>
                La gesti&oacute;n de estacionamientos y carritos desde superadmin requiere los endpoints <code style={{ backgroundColor: "rgba(0,0,0,0.05)", padding: "0.1rem 0.3rem", borderRadius: "0.25rem" }}>GET /api/super-admin/assets</code> en el backend.
                Las rutas existen pero devuelven error 500. Una vez corregidas, esta p&aacute;gina mostrar&aacute; y permitir&aacute; gestionar todos los activos.
              </p>
            </div>
          </div>
        </>
